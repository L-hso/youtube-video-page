...
export function NavbarSearchBar() {
  return (
    <div className="md:absolute md:left-1/2 md:-translate-x-1/2 flex justify-center w-1/2">
      <input
        className="rounded-l-full outline-none h-9 border-[0.85px] border-[#666] bg-[#444] text-sm text-gray-200 placeholder:text-youtube-light-gray pl-4 max-w-96 flex-1"
