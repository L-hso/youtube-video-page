import { NavbarAsideSection } from "./NavbarMenuLateralSections";
...
export function NavbarAside({ visible }: { visible: boolean }) {
  ...
  return (
    <>
      <nav
        data-ativo={visible}
        className="bg-youtube-darkest overflow-y-auto new-scrollbar transition-transform duration-300 -translate-x-full  flex-col justify-start items-around max-w-[15.5rem] px-4 py-2 data-[ativo=true]:translate-x-0 *:text-white absolute top-14 h-[calc(100vh-3.5rem)] z-20"
      >
